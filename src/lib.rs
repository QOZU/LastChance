...
#[derive(Debug)]
pub struct LastChanceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LastChanceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LastChance processing");
    
    let mut processor = LastChanceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LastChanceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LastChanceProcessor::new(false);
